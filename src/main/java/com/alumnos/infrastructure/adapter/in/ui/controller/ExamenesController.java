...
public class ExamenesController extends BaseController {
    ...
    private VBox crearTabla() {
        ...
        tablaExamenes.setMaxHeight(Double.MAX_VALUE);
        tablaExamenes.setMaxWidth(Double.MAX_VALUE);
        javafx.scene.layout.VBox.setVgrow(tablaExamenes, javafx.scene.layout.Priority.ALWAYS);
